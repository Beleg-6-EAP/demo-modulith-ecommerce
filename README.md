...
[![Maven Build & Tests](https://github.com/Beleg-6-EAP/demo-modulith-ecommerce/actions/workflows/maven-build-test.yml/badge.svg)](https://github.com/Beleg-6-EAP/demo-modulith-ecommerce/actions/workflows/maven-build-test.yml)

# Modulith E-Commerce Demo

This repository provides a minimal example showcasing the Modular Monolithic Architecture in an E-Commerce setting.
...
```bash
bash> sudo docker build -t demo-modulith-ecommerce .
bash> sudo docker run -p 8080:8080 demo-modulith-ecommerce  
```
